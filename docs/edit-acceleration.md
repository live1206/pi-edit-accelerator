...
|---|---:|---:|---:|
| Built-in A | 420.78 ms | 483.52 ms | 430.34 ms |
| Sparse extension C | 134.18 ms | 172.87 ms | 136.59 ms |

Candidate C reduced median execution latency by approximately 68% on this stress fixture.
